...
def _config_defaults():
    return {
        ...
        SiteConfig.KEY_STORYBOARD_SINGLE_PANEL_PROMPT: DEFAULT_STORYBOARD_SINGLE_PANEL_PROMPT,
        SiteConfig.KEY_STORYBOARD_VIDEO_PROMPT: DEFAULT_STORYBOARD_VIDEO_PROMPT,
        SiteConfig.KEY_AI_SCRIPT_LIVE_ACTION_STYLE_PROMPT: DEFAULT_SCRIPT_LIVE_ACTION_STYLE_PROMPT,
        SiteConfig.KEY_AI_SCRIPT_ANIME_3D_STYLE_PROMPT: DEFAULT_SCRIPT_ANIME_3D_STYLE_PROMPT,
        ...
        SiteConfig.KEY_SCENE_INFERENCE_RIGHT_PROMPT: DEFAULT_SCENE_INFERENCE_RIGHT_PROMPT,
        SiteConfig.KEY_SCENE_INFERENCE_TOP_PROMPT: DEFAULT_SCENE_INFERENCE_TOP_PROMPT,
        SiteConfig.KEY_SCENE_INFERENCE_PANORAMA_PROMPT: DEFAULT_SCENE_INFERENCE_PANORAMA_PROMPT,
    }
