...
AI_CS_WEB_TOP_K = env.int("AI_CS_WEB_TOP_K", default=5)
...
AI_CS_MCP_SEARCH_ENABLED = env.bool("AI_CS_MCP_SEARCH_ENABLED", default=False)
AI_CS_MCP_SEARCH_URL = env("AI_CS_MCP_SEARCH_URL", default="")
AI_CS_MCP_SEARCH_API_KEY = env("AI_CS_MCP_SEARCH_API_KEY", default="")
AI_CS_MCP_SEARCH_TIMEOUT = env.int("AI_CS_MCP_SEARCH_TIMEOUT", default=12)
