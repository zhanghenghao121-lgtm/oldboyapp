...
STANDPOSER_MAX_UPLOAD_SIZE = env.int("STANDPOSER_MAX_UPLOAD_SIZE", default=80 * 1024 * 1024)
STANDPOSER_SIGNED_URL_TTL = env.int("STANDPOSER_SIGNED_URL_TTL", default=3600)
