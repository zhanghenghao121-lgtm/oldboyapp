...
IMAGE_SOURCE_MAX_UPLOAD_SIZE = env.int("IMAGE_SOURCE_MAX_UPLOAD_SIZE", default=80 * 1024 * 1024)
...
EMAIL_CODE_IP_LIMIT_PER_MINUTE = env.int("EMAIL_CODE_IP_LIMIT_PER_MINUTE", default=10)
...
AI_IMAGE_SUBMIT_TIMEOUT = env.int("AI_IMAGE_SUBMIT_TIMEOUT", default=180)
AI_IMAGE_QUERY_TIMEOUT = env.int("AI_IMAGE_QUERY_TIMEOUT", default=30)
...
QDRANT_API_KEY = env("QDRANT_API_KEY", default="") or None
QDRANT_COLLECTION = env("QDRANT_COLLECTION", default="octopus_planet_notes")
QDRANT_VECTOR_NAME = env("QDRANT_VECTOR_NAME", default="tag_vector")
OCTOPUS_PLANET_MAX_TAG_LENGTH = env.int("OCTOPUS_PLANET_MAX_TAG_LENGTH", default=10)
OCTOPUS_PLANET_COMMON_TAG_LIMIT = env.int("OCTOPUS_PLANET_COMMON_TAG_LIMIT", default=5)
OCTOPUS_PLANET_SEARCH_LIMIT = env.int("OCTOPUS_PLANET_SEARCH_LIMIT", default=200)
