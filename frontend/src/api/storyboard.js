...
export const generateStoryboardPanels = (segmentId, payload) => http.post(`/storyboard/segments/${segmentId}/generate-panels`, payload, { timeout: 600000 })
...
export const generateStoryboardVideoPrompts = (segmentId) => http.post(`/storyboard/segments/${segmentId}/generate-video-prompts`, {}, { timeout: 180000 })
